...
public class CreateStandaloneCompilerJar extends CreateStandaloneJar {
    ...
    protected Info computeInfo() {
        return new Info().addAdditionalRoots(UtilitiesSPIImpl.class.getName(), "com.sun.tools.javac.Main", HintsAnnotationProcessing.class.getName())
                         .addMetaInfRegistrations(new MetaInfRegistration(Utilities.SPI.class, UtilitiesSPIImpl.class))
                         .addMetaInfRegistrations(new MetaInfRegistration(Processor.class, HintsAnnotationProcessing.class));
    }
