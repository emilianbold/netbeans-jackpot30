 ...
 * @author lahvac
 */
@ServiceProvider(service=SPI.class, position=100)
public class UtilitiesSPIImpl implements SPI {
    ...
    public Scope constructScope(CompilationInfo info, Map<String, TypeMirror> constraints, Iterable<? extends String> auxiliaryImports) {
        return Utilities.constructScope(info, constraints, auxiliaryImports);
    }
