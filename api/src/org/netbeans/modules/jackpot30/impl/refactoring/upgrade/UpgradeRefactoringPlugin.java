 ...
 * @author lahvac
 */
public class UpgradeRefactoringPlugin extends AbstractApplyHintsRefactoringPlugin {
    
    private final UpgradeRefactoring upgradeRefactoring;

    public UpgradeRefactoringPlugin(UpgradeRefactoring upgradeRefactoring) {
        super(upgradeRefactoring);
        this.upgradeRefactoring = upgradeRefactoring;
    }
