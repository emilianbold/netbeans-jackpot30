 ...
 * @author lahvac
 */
public class ExplicitFindDuplicates implements CancellableTask<CompilationInfo> {
    ...
    public void run(CompilationInfo info) throws Exception {
        ...
        HintsController.setErrors(info.getFileObject(), ExplicitFindDuplicates.class.getName(), eds);
    }
    ...
    public static final class FactoryImpl extends SelectionAwareJavaSourceTaskFactory {
        ...
        protected CancellableTask<CompilationInfo> createTask(FileObject file) {
            return new ExplicitFindDuplicates();
        }
