...
public class Installer extends ModuleInstall {
    ...
    public void validate() throws IllegalStateException {
        try {
            Class<?> main = Class.forName("org.netbeans.core.startup.Main", false,  //NOI18N
            ...
            Object persistence = moduleMeth.invoke(moduleManager, "org.netbeans.modules.gototest"); //NOI18N
            if (persistence != null) {
                ...
                friends.add("org.netbeans.modules.jackpot30.file"); //NOI18N
            }
        } catch (Exception ex) {
            new IllegalStateException("Cannot fix dependencies for org.netbeans.modules.jackpot30.file.", ex); //NOI18N
        }
        super.validate();
    }
}
